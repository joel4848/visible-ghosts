 ...
 *
 * This is purely in-memory: overrides do NOT persist across server restarts.
 * The default for every player is {@link OverrideState#NONE}.
 *
 * Thread-safety: uses {@link ConcurrentHashMap} so it is safe to read/write
 * from both the server tick thread and any networking threads.
 */
